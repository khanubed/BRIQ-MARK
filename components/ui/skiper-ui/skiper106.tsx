...
const Textarea = ({ className, wrapperClassName, ...props }: TextareaFieldProps) => {
  return (
    <div className={cn(inputWrapperClassName, wrapperClassName, "h-auto")}>
      <textarea className={cn(inputClassName, className, "resize-none min-h-[120px]")} {...props} />
    </div>
  );
};
...
export { Input, Skiper106, SmoothInput, Textarea };
